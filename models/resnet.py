...
__all__ = ['ResNet', 'resnet18', 'resnet18_fc_ma', 'resnet50', 'resnet50_fc_ma']
...
class ResNetFcMaxAct(AbstractResNet):
    ...
    def __init__(self, block, layers, num_classes=1000, topk=5):
        super(ResNetFcMaxAct, self).__init__(block, layers, num_classes)
        self.rfc = RouteFcMaxAct(512 * block.expansion, num_classes, topk=topk)
        self._initial_weight()
...
class ResNetCifarMaxAct(AbstractResNet):
    def __init__(self, block, layers, num_classes=10, topk=5):
